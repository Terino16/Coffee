...
const Footer = () => {
  return (
    <div>
<footer className="p-2 bg-white sm:p-6 dark:bg-md-red-100">
    <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
        <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-black">Koffee</span>
        </div>
        <div className="grid grid-cols-2 items-start gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Kofee™</a>. All Rights Reserved.
        </span>
